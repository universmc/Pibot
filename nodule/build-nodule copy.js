...
const Telegraf = require('telegraf');
const bot = new Telegraf("Votre token d'API");
...
const nodule = process.argv[2] || 'EcoSystem-_Blender'; //  Obtenir le sujet via l'argument de ligne de commande

const nodeJs = [
     "howto-EcoSystem-_Blender",
