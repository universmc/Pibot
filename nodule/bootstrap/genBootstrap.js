...
const Composants = [
  ...
  "dashboard-rtl",
  "navbar-static",
  "badges","dropdowns", "navbars",
  "blog","features", "navbars-offcanvas",
  "blog-rtl","footers", "offcanvas",
  "breadcrumbs","grid", "offcanvas-navbar",
  "buttons","headers", "pricing",
  "carousel","heroes", "product",
  "carousel-rtl","jumbotron", "sidebars",
  "cheatsheet","jumbotrons", "sign-in",
  "cheatsheet-rtl","list-groups", "starter-template",
  "checkout","masonry", "sticky-footer",
  "checkout-rtl","modals", "sticky-footer-navbar"
];
